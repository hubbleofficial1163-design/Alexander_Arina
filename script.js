...
const CONFIG = {
    ...
    TELEGRAM_CHAT_URL: 'https://t.me/+hOTwI3ZDYy', // ЗАМЕНИТЕ НА ВАШУ ССЫЛКУ НА ЧАТ
    WEDDING_DATE: '2026-08-29T14:30:00' // Дата и время начала сбора гостей
};
...
function initMusic() {
    ...
    audio.src = '1.mp3'; // Путь к вашему аудиофайлу
    audio.loop = true;
    audio.volume = 0.5;
