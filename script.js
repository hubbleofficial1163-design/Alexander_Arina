// ==============================================
// СВАДЕБНЫЙ САЙТ - АЛЕКСАНДР & АРИНА
...
(function() {
    ...
    const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbz_VcjCrU5IkjkyEh4IXPmZjBajwZkP94QWY1-RtuEKcguxxHFF8Y_VgBtjjguF9OOhmQ/exec';
    ...
    async function sendToGoogleSheets(formData) {
        ...
        formBody.append('overnight', formData.overnight);
    ...
    function updateCountdown() {
        const weddingDate = new Date('2026-08-29T14:30:00').getTime();
    ...
    function initRSVPForm() {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            overnightRadios.forEach(radio => {
                if (radio.checked) overnight = radio.value;
            });
            ...
            try {
                ...
                if (result.result === 'success') {
                    ...
                    overnightRadios.forEach(radio => radio.checked = false);
